...
<div id="contnent">
	<div
		style="color: #000000; background-color: #ffffff; padding-top: 150px; padding-bottom: 150px;">
		이름&nbsp; <input type="text" id="p_name" name="p_name">
		&nbsp;&nbsp;아이디&nbsp; <input type="text" id="p_id" name="p_id">&nbsp;&nbsp;
		이메일 &nbsp; <input type="email" id="p_mail" name="p_mail">&nbsp;&nbsp;&nbsp;
		<input type="button" value="인증번호 요청" id="code_req" class="btn btn-danger" style="background:pink; color: black;">
		<br/><br/>
