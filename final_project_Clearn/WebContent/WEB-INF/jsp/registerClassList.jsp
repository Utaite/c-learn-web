...
<div>
	...
	<div style="width: 1000px; text-align: left;">
		<input type="button" value="퀴즈확인"
			onclick="javascript:qpopupOpen(${sessionScope.p_num })" class="btn btn-danger"> &nbsp;&nbsp;&nbsp;<input
			type="button" value="접속기록확인"
			onclick="javascript:cpopupOpen(${sessionScope.p_num })" class="btn btn-danger"> <br />
		<br />
	</div>
	<table class="table">
		<tr>
			...
			<tr>
				...
				<td>
					<form method="post" action="watchAndroid">
						...
						<input type="submit" value="학습하기" class="btn btn-info">
					</form>
				</td>
			</tr>
		</c:forEach>
